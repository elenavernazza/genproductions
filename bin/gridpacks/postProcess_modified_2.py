...
def calcTotXS1 (singleGenInfoList):

    H = ROOT.TH1D()
    for x, e, n in singleGenInfoList:
        H.Fill(x)
    XS = H.GetMean()
    XSe = H.GetRMS()/H.GetEntries()
...
def makeNtupleProdCfg (basefolder,outfolder, LHEfiles, XS):
    ...
    outf.write ('variables = mjj, mll, ptj1, ptj2, etaj1, etaj2, phij1, phij2, ptl1, ptl2, ptl3, etal1, etal2, met, ptll, deltaetajj, deltaphijj\n')
    outf.write ('outputFile = /eos/user/e/evernazz/LHE_ntuple_WZin/ntuple_' + processName + '.root\n')
