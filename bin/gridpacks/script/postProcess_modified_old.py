...
def makeNtupleProdCfg (basefolder,outfolder, LHEfiles, XS):
    ...
    outf.write ('variables = mjj, mll, ptj1, ptj2, etaj1, etaj2, phij1, phij2, ptl1, ptl2, ptl3, etal1, etal2, etal3, met, ptll, deltaetajj, deltaphijj\n')
    outf.write ('outputFile = ~/ntuple/ntuple_' + processName + '.root\n')
    # outf.write ('outputFile = ' + os.getcwd() + '/' + outfolder +'/ntuple_' + processName + '.root\n')
